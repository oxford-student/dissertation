...
sd_abun$ci <- (sd_abun$abun_f * 2.262)/sqrt(10) # calculation of confidence interval
                                                # based on small sample size correction
...
sd_rich$ci <- (sd_rich$rich_f * 2.262)/sqrt(10)
...
sd_div$ci <- (sd_div$div_f * 2.262)/sqrt(10)
...
sd_reldiv$ci <- (sd_reldiv$rel_div_f * 2.262)/sqrt(10)
